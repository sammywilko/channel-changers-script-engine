...
interface MentionPickerProps {
  ...
  allowCreate?: boolean;
  /** Source app for new assets */
  sourceApp?: 'script-engine' | 'design-agent' | 'director' | 'marketing-suite';
  ...
  useEffect(() => {
    ...
    const handleInput = () => {
      ...
      if (atMatch) {
        ...
        // This is a simplified version - for accurate positioning use a library
